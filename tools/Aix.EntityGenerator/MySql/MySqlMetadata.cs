...
namespace Aix.EntityGenerator.MySql
{
   public class MySqlMetadata: IDBMetadata
    {
        ...
        public List<TableInfo> QueryTable(string db)
        {
        ...
        public List<ColumnInfo> QueryColumn(string db)
        {
        ...
        public List<PrimaryKey> QueryPrimaryKey(string db)
        {
