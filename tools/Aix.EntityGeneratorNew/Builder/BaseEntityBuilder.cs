...
namespace Aix.EntityGeneratorNew.Builder
{
    public abstract class BaseEntityBuilder : IEntityBuilder
    {
        ...
        public BaseEntityBuilder()
        {
            ...
            _logger = ServiceLocator.Instance.GetService<ILogger<BaseEntityBuilder>>();
        }

        protected string BuilderHead()
        {
        ...
        public virtual BuilderResult Builder(ORMDBType dbType, string connectionStrings)
        {
